...
//euro
  ...
  fetch("https://economia.awesomeapi.com.br/json/daily/KRW-USD/15").then((res2)=>{return res2.json()}).then((data2)=>{ 
    ...
    dashs[0].innerHTML = '<img class="usa-flag" src="coreia-do-sul.png" alt="korea-flag"> <p>Coreia do Sul</p><p>Ásia Central</p><p>Geralmente é a moeda referencia da economia global</p>';
