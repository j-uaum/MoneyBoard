...
//euro
    ...
    dashs[0].innerHTML = `<img class="usa-flag" src="./europe-flag.png" alt="european-flag"> <p class="titulo-bandeira">União Europeia</p><p class="subtitulo-bandeira">Zona do euro</p>`;
    dashs[1].innerHTML = `<h3>Cotação Atual</h3><br> <h1 class="alta"> ${parseFloat(euro.high).toLocaleString('pt-br', {style:'currency', currency: 'BRL'})}</h1><br> <h1 class="baixa"> ${parseFloat(euro.low).toLocaleString('pt-br', {style:'currency', currency: 'BRL'})}</h1>`
   ...
   dashs[3].innerHTML = "<h2>Principais pontos da econômia</h2><br><li>Turismo</li><br><li>Serviços e empresas</li><br><li>Industria</li><br><li>Esporte e Entretenimento</li><br> <li>Tecnologia</li><br> <li>Mineração</li>  "
