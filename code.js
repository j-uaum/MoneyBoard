...
btn.addEventListener('click', () => {
  ...
  fetch("https://economia.awesomeapi.com.br/json/daily/USD-BRL/15").then((res2)=>{return res2.json()}).then((data2)=>{ 
    ...
    dashs[1].innerHTML = `<h3>Cotação Atual</h3><br> <p id="alta"> ${parseFloat(dolar.high).toLocaleString('pt-br', {style:'currency', currency: 'BRL'})}</p><br> <h1 id="baixa">Baixa:${parseFloat(dolar.low).toLocaleString('pt-br', {style:'currency', currency: 'BRL'})}</h1>`
